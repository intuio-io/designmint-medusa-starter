...
const Featured = ({ products }: any) => {
  return (
    <section aria-labelledby="favorites-heading">
      <div className="mx-auto px-8 py-24 sm:px-6 sm:py-2 lg:px-8">
        <div className="sm:flex sm:items-baseline sm:justify-between">
          ...
          <a
            href={`${process.env.NEXT_PUBLIC_BASE_URL}/store`}
        ...
        <div className="mt-6 grid grid-cols-2 gap-x-2 gap-y-10 sm:grid-cols-6 sm:gap-x-6 sm:gap-y-0 lg:gap-x-8">
